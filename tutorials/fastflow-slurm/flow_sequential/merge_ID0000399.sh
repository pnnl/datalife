mkdir -p $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/merge_ID0000399
cd $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/merge_ID0000399
...
echo ID0000399,merge,$duration,$start,$node13 >> $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/stat.log
date +%s,%H:%M:%S >> ${0}.log
