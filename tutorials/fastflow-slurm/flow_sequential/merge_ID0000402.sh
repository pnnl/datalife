mkdir -p $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/merge_ID0000402
cd $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/merge_ID0000402
...
echo ID0000402,merge,$duration,$start,$node0 >> $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/stat.log
date +%s,%H:%M:%S >> ${0}.log
