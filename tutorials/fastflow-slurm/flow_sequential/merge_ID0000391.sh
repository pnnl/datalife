mkdir -p $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/merge_ID0000391
cd $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/merge_ID0000391
...
echo ID0000391,merge,$duration,$start,$node5 >> $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/stat.log
date +%s,%H:%M:%S >> ${0}.log
