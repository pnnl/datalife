mkdir -p $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/merge_ID0000389
cd $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/merge_ID0000389
...
echo ID0000389,merge,$duration,$start,$node3 >> $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/stat.log
date +%s,%H:%M:%S >> ${0}.log
