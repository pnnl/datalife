mkdir -p $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/merge_ID0000394
cd $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/merge_ID0000394
...
echo ID0000394,merge,$duration,$start,$node8 >> $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/stat.log
date +%s,%H:%M:%S >> ${0}.log
