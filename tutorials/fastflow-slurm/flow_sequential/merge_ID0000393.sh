mkdir -p $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/merge_ID0000393
cd $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/merge_ID0000393
...
echo ID0000393,merge,$duration,$start,$node7 >> $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/stat.log
date +%s,%H:%M:%S >> ${0}.log
