mkdir -p $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/merge_ID0000387
cd $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/merge_ID0000387
...
echo ID0000387,merge,$duration,$start,$node1 >> $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/stat.log
date +%s,%H:%M:%S >> ${0}.log
