mkdir -p $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/merge_ID0000386
cd $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/merge_ID0000386
...
echo ID0000386,merge,$duration,$start,$node0 >> $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/stat.log
date +%s,%H:%M:%S >> ${0}.log
