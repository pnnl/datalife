mkdir -p $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/merge_ID0000400
cd $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/merge_ID0000400
...
echo ID0000400,merge,$duration,$start,$node14 >> $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/stat.log
date +%s,%H:%M:%S >> ${0}.log
