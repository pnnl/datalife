mkdir -p $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/merge_ID0000395
cd $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/merge_ID0000395
...
echo ID0000395,merge,$duration,$start,$node9 >> $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/stat.log
date +%s,%H:%M:%S >> ${0}.log
