mkdir -p $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/merge_ID0000390
cd $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/merge_ID0000390
...
echo ID0000390,merge,$duration,$start,$node4 >> $PFS_PATH/sra-search-workflow/192sras_large/16nodes/dfman/stat.log
date +%s,%H:%M:%S >> ${0}.log
