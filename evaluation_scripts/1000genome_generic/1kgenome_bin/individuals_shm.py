...
import ctypes
#c_mpi_lib = ctypes.CDLL('/qfs/projects/oddite/hermes_stage/my_libs/c_mpi.so')
...
def processing(inputfile, columfile, c, counter, stop, total, shm):
    ...
    ndir = shm + 'chr{}n-{}-{}/'.format(c, counter, stop)
    ...
    outputfile = shm + "chr{}n-{}-{}.tar.gz".format(c, counter, stop)
...
if __name__ == "__main__":
    ...
    if "LOCAL_STORE" in os.environ:
        shm=os.environ.get('LOCAL_STORE') + "/"
    else:
        shm = "/dev/shm/"
